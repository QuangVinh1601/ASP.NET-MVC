...
namespace WebAppMVC_1.Areas.Contact.Controllers
{
    public class Contact : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,DateSend,Message")] ContactModel contactModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,DateSend,Message")] ContactModel contactModel)
        {
